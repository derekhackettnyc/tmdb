        ...
        <Fragment>
            ...
            <section className="home">
                <h1 className="main-heading">
                    <span className="main-heading--main moveInLeft">React Movies/TV</span>
                    <span className="main-heading--sub moveInRight">Movies, TV shows and people to discover</span>
                </h1>
            </section>
